...
from fx_lib.models import Order, Position, Trade, Granularity, Instrument, Candlestick
from fx_lib.models.instruments import InstrumentSubscription, InstrumentHistory

from ._util import _as_str, Data, Indicator, try_
...
class Strategy(metaclass=ABCMeta):
    ...
    def I(self,  # noqa: E741, E743
        ...
        value = Indicator(value, name=name, plot=plot, overlay=overlay,
...
class FxStrategy:
    ...
    def __init__(self, broker: FxBroker, max_history=100):
        ...
        self._history = InstrumentHistory(max_history=max_history)
    ...
    @property
    @abstractmethod
    def subscriptions(self) -> List[InstrumentSubscription]:
    ...
    def _monitor_instruments(self):
        for subscription in self.subscriptions:
            self.broker.subscribe(subscription.instrument, subscription.granularity, self._update_instrument)

    def _update_instrument(self, candle: Candlestick):
        self._history.update(candle)
    ...
    @abstractmethod
    def next(self):
        # Evaluate indicators and submit orders
        pass
