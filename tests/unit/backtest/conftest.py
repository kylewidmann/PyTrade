...
def test_csv_sources() -> list[CsvDataSource]:
    return [
        CsvDataSource(
            "tests/unit/backtest/assets/EURGBP-2024-05_1Min.csv",
            FxInstrument.EURGBP,
            Granularity.M1,
        ),
        CsvDataSource(
            "tests/unit/backtest/assets/EURJPY-2024-05_1Min.csv",
            FxInstrument.EURJPY,
            Granularity.M1,
        ),
        CsvDataSource(
            "tests/unit/backtest/assets/EURUSD-2024-05_1Min.csv",
            FxInstrument.EURUSD,
            Granularity.M1,
        ),
        CsvDataSource(
            "tests/unit/backtest/assets/GBPUSD-2024-05_1Min.csv",
            FxInstrument.GBPUSD,
            Granularity.M1,
        ),
        CsvDataSource(
            "tests/unit/backtest/assets/EURGBP-2024-05_5Min.csv",
            FxInstrument.EURGBP,
            Granularity.M5,
        ),
        CsvDataSource(
            "tests/unit/backtest/assets/EURJPY-2024-05_5Min.csv",
            FxInstrument.EURJPY,
            Granularity.M5,
        ),
        CsvDataSource(
            "tests/unit/backtest/assets/EURUSD-2024-05_5Min.csv",
            FxInstrument.EURUSD,
            Granularity.M5,
        ),
        CsvDataSource(
            "tests/unit/backtest/assets/GBPUSD-2024-05_5Min.csv",
            FxInstrument.GBPUSD,
            Granularity.M5,
        ),
    ]
...
def test_stock_sources() -> list[CsvDataSource]:
    return [
        CsvDataSource(
            "tests/unit/backtest/assets/GOOG.csv",
            "GOOG",
            Granularity.D1,
        )
    ]
