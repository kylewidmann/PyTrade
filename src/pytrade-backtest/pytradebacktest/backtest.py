...
class Backtest:
    ...
    async def run(self, **kwargs):
        ...
        _original_update = Indicator._update
        ...
        # Restore the original Indicator._update so subsequent non-backtest
        # indicator usage (e.g. pytrade unit tests using CandleData) is unaffected
        Indicator._update = _original_update
